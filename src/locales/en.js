export default {
	...
	'/login': {
		...
		fields: [
			{ name: 'email', message: 'Email must be in valid format' },
			{
				name: 'password',
				message:
					'The password must contain at least a capital letter, a number, a special character and a minimum of 8 characters'
			}
		],
	...
	'/join': {
		...
		title: 'Join us and organize your to-do list in a better way',
		subtitle:
			'Fill in the requested fields to create your account and use our application.',
		phName: 'Name',
		phSurname: 'Surname',
		phUsername: 'Username',
		phEmail: 'example@domain.com',
		...
		fields: [
			{
				name: 'name',
				message:
					'The name must only contain characters and a minimum of 4 characters'
			},
			{
				name: 'surname',
				message:
					'The last name must only contain characters and a minimum of 4 characters'
			},
			{
				name: 'username',
				message:
					'The username is a combination of characters and periods with a minimum of 3 characters'
			},
			{ name: 'email', message: 'Email must be in valid format' },
			{
				name: 'password',
				message:
					'The password must contain at least one capital letter, one number, one special character and a minimum of 8 characters'
			},
			{
				name: 'confirm',
				message:
					'The confirmation must contain at least one capital letter, one number, one special character and a minimum of 8 characters'
			}
		],
	...
	'/dashboard': {
		...
		countTasks: ['You have', 'tasks pending'],
		phTaskCreator: ['Write a new task.', 'to create'],
