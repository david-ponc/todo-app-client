export default {
	...
	'/login': {
		...
		footer: 'Inspirado en',
		title:
			'Únete a nosotros y organiza tu lista de pendientes de una mejor manera',
	...
	'/join': {
		...
		subtitle:
			'Rellena los campos solicitados para crear tu cuenta y utiliza nuestra aplicación.',
		...
		fields: [
			...
			},
			{
				name: 'username',
				message:
					'El nombre de usuario es una combinación de letras y puntos con un mínimo de 3 letras'
			},
			{
				name: 'email',
				message: 'El correo electrónico debe tener un formato válido'
			...
			},
			{
				name: 'confirm',
				message:
					'La confirmación debe contener al menos un mayúscula, un numero, un carácter especial y un mínimo de 8 caracteres'
			}
		],
	...
	'/dashboard': {
		...
		phTaskCreator: ['Escribe una tarea.', 'para crear'],
