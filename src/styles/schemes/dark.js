export default {
	...
	colors: {
		body: {
			...
			gradientText:
				'linear-gradient(271deg,var(--success-700) 0%,var(--error-700) 50%, var(--primary-700) 100%)'
		},
		link: {
		...
		button: {
			primary: {
				...
				text: 'var(--gray-100)',
				shadow:
					'0px 18px 24px -11px rgba(22, 23, 29, 0.75), inset 0px 0px 0px 1px rgba(143, 116, 36, 0.25)'
			},
			neutral: {
				background: 'var(--gray-300)',
				text: 'var(--gray-800)',
				shadow:
					'0px 18px 24px -11px rgba(22, 23, 29, 0.75), inset 0px 0px 0px 1px rgba(240, 241, 247, 0.04)'
			}
		},
		check: {
		...
		dropdown: {
			...
			color: 'var(--gray-500)',
			border:
				'0px 18px 24px -11px rgba(22, 23, 29, 0.75), inset 0px 0px 0px 1px rgba(240, 241, 247, 0.06)',
			hover: 'var(--gray-400)',
		...
		alert: {
			close: 'var(--gray-400)',
			shadow:
				'0px 2px 9px -4px rgba(22, 23, 29, 0.16), inset 0px 0px 0px 1px rgba(240, 241, 247, 0.06)',
			success: {
				title: 'var(--success-400)',
				subtitle: 'var(--success-600)',
				background:
					'linear-gradient(90deg, var(--success-100) 0%, var(--gray-300) 50%, var(--gray-300) 100%)',
			...
			error: {
				...
				background:
					'linear-gradient(90deg, var(--error-100) 0%, var(--gray-300) 50%, var(--gray-300) 100%)',
				icon: 'var(--error-500)',
			...
			warning: {
				...
				background:
					'linear-gradient(90deg, var(--primary-100) 0%, var(--gray-300) 50%, var(--gray-300) 100%)',
			...
			info: {
				...
				background:
					'linear-gradient(90deg, var(--gray-100) 0%, var(--gray-300) 50%, var(--gray-300) 100%)',
				icon: 'var(--gray-600)',
