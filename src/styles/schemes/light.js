const lightScheme = {
	...
	colors: {
		body: {
			...
			gradientText:
				'linear-gradient(271deg,var(--success-300) 0%,var(--error-200) 50%,var(--primary-300) 100%)'
		},
		link: {
		...
		button: {
			primary: {
				...
				text: 'var(--gray-100)',
				shadow:
					'0px 18px 24px -11px rgba(22, 23, 29, 0.16), inset 0px 0px 0px 1px rgba(143, 116, 36, 0.25)'
			},
			neutral: {
				background: 'var(--gray-700)',
				text: 'var(--gray-100)',
				shadow:
					'0px 18px 24px -11px rgba(22, 23, 29, 0.16), inset 0px 0px 0px 1px rgba(22, 23, 29, 0.05)'
			}
		},
		check: {
			background: 'var(--gray-800)',
		...
		dropdown: {
			...
			color: 'var(--gray-600)',
			border:
				'0px 0px 0px 0.5px rgba(22, 23, 29, 0.09), 0px 6px 24px -8px rgba(22, 24, 29, 0.25)',
			hover: 'var(--gray-700)',
		...
		alert: {
			close: 'var(--gray-500)',
			shadow:
				'0px 2px 9px -4px rgba(22, 23, 29, 0.16), inset 0px 0px 0px 0.5px rgba(22, 23, 29, 0.09)',
			success: {
				title: 'var(--success-200)',
				subtitle: 'var(--success-100)',
				background:
					'linear-gradient(90deg, #055C4254 0%, var(--gray-700) 50%, var(--gray-700) 100%)',
			...
			error: {
				...
				background:
					'linear-gradient(90deg, var(--error-700) 0%, var(--gray-700) 50%, var(--gray-700) 100%)',
				icon: 'var(--error-300)',
			...
			warning: {
				...
				background:
					'linear-gradient(90deg, #4F401454 0%, var(--gray-700) 50%, var(--gray-700) 100%)',
			...
			info: {
				...
				background:
					'linear-gradient(90deg, #484C5C54 0%, var(--gray-700) 50%, var(--gray-700) 100%)',
				icon: 'var(--gray-600)',
