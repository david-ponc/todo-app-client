	...
	if (isSuccessProcess) {
		return (
			<Layout t={t} navbar={{ links: t.links, navbarButton: t.navbarButton }}>
				<SuccessContent
					t={t}
					fullName={`${form.fields.name.value} ${form.fields.surname.value}`}
				/>
			</Layout>
		);
	}
	...
	return (
		<>
			...
			<Form onSubmit={handleSubmit}>
				...
				/>
				<TextField
					error={form.fields.confirm}
					placeholder={t.phConfirm}
					type='password'
					{...form.getInput('confirm')}
				/>
				<Terms>{t.p}</Terms>
