...
const initialTasks = [
	{
		_id: '3452',
		content: 'Hacer el diseño de la web',
		category: 'work',
		completed: false
	},
	{
	...
	{
		_id: '7638',
		content: 'Reunión para análisis de requerimientos',
		category: 'work',
		completed: false
	},
	{
		_id: '5634',
		content: 'Hacer un todo list',
		category: 'personal',
		completed: false
	}
];
		...
		<>
			...
			<div style={{ maxWidth: '640px', margin: '0 auto' }}>
				<Landing
					...
					animate='animate'
					exit='exit'
					variants={varsLanding}
				>
					<Title>{t.title}</Title>
					<Subtitle>{t.subtitle}</Subtitle>
					<Leyend>{t.p}</Leyend>
					<Button onClick={sendStart} color='primary'>
						{t.landingButton}
					</Button>
				</Landing>
				{tasks.length === 0 && (
					<div style={{ width: '32px', margin: '7rem auto 0' }}>
						<Loader size={32} />
					</div>
				)}
				<TaskContainer
